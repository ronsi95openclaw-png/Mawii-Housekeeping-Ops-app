...
import { LoadingState, ErrorState, EmptyState, PageIntro, Avatar, DetailPane } from '@/lib/shared';
    ...
    <div className="content-stack">
      ...
      {filtered.length ? (
        <div className="jobs-layout">
          ...
          {selectedCustomer ? (
            <DetailPane onClose={() => setSelectedCustomer(null)} label="Close client" testId="button-close-customer-detail">
